...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const presentaciones = [
        ...
        { 
        id: "Limpieza de Cabezales", 
        titulo: "Limpieza de Cabezales", 
        descripcion: "Instalación y ejecución de sistema operativo de arranque Windows 10", 
        urlEmbed: "https://drive.google.com/file/d/1HEeZHDd41ahE8PV5toPAQUG6OKqO63GM/preview",
        urlDescargaPres: "https://drive.google.com/file/d/1HEeZHDd41ahE8PV5toPAQUG6OKqO63GM/view?usp=drivesdk", 
    ...
    let htmlGenerado = `
        <div class="section-dark-title-container">
            ...
            <h2 class="main-section-title">Mantenimiento y configuración de periféricos</h2>
        </div>
    `;

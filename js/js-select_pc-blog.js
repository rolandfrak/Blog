...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const presentaciones = [
        ...
        { 
        id: "Restablecer Contraseña en Windows", 
        titulo: "Restablecer Contraseña en Windows", 
        descripcion: "Restablecer Contraseña en Windows 10, conservando los archivos y carpetas del usuario", 
        urlEmbed: "https://drive.google.com/file/d/1hKr_dpqlQKDcnG__JBpXo7JbyKlRz7np/preview",
        urlDescargaPres: "https://drive.google.com/file/d/1hKr_dpqlQKDcnG__JBpXo7JbyKlRz7np/view?usp=drivesdk", 
        urlDescargaPdf: "https://drive.google.com/file/d/1dySAWal_h8hPPh1U3Ugbr1HwXCa1qtNM/view?usp=drivesdk" 
        }
    ...
    let htmlGenerado = `
        <div class="section-dark-title-container">
            ...
            <h2 class="main-section-title">Mantenimiento Ensamblaje y configuración de PCs</h2>
        </div>
    `;

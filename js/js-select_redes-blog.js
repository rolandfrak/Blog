...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const presentaciones = [
        ...
        { 
        id: "Restablecer Contraseña Wifi", 
        titulo: "Restablecer Contraseña Wifi", 
        descripcion: "Restablecer Contraseña de Internet wifi, con router Tp-Link", 
        urlEmbed: "https://drive.google.com/file/d/11oDdJsu2E2vtq8tt5xSa-fv7ASQsCTky/preview",
        urlDescargaPres: "https://drive.google.com/file/d/11oDdJsu2E2vtq8tt5xSa-fv7ASQsCTky/view?usp=drivesdk", 
        urlDescargaPdf: "https://drive.google.com/file/d/1f0E-XE-trtp5ONEwH412uVkjsY1Glzlh/view?usp=drivesdk" 
        }
    ...
    let htmlGenerado = `
        <div class="section-dark-title-container">
            ...
            <h2 class="main-section-title">Administración de Redes Informáticas</h2>
        </div>
    `;
